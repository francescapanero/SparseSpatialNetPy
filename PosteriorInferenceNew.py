...
plt.xlabel('iter')
plt.ylabel('log_post')
plt.savefig('images/all_trueinit5/logpost')
plt.close()
...
plt.xlabel('iter')
plt.ylabel('sigma')
plt.savefig('images/all_trueinit5/sigma')
plt.close()
...
plt.xlabel('iter')
plt.ylabel('c')
plt.savefig('images/all_trueinit5/c')
plt.close()
...
plt.xlabel('iter')
plt.ylabel('t')
plt.savefig('images/all_trueinit5/t')
plt.close()
...
plt.legend()
plt.savefig('images/all_trueinit5/w0_trace')
plt.close()
...
plt.savefig('images/all_trueinit5/w0_CI')
plt.close()
...
plt.xlim(0, 100)
plt.savefig('images/all_trueinit5/autocor_sigma')
plt.close()
plt.figure()
plt.acorr(output[4], detrend=plt.mlab.detrend_mean, maxlags=100)
plt.xlim(0, 100)
plt.savefig('images/all_trueinit5/autocor_c')
plt.close()
plt.figure()
plt.acorr(output[5], detrend=plt.mlab.detrend_mean, maxlags=100)
plt.xlim(0, 100)
plt.savefig('images/all_trueinit5/autocor_t')
plt.close()
...
# plt.xlabel('iter')
# plt.ylabel('log_post')
# plt.savefig('images/all_rand5/log_post5000')
# plt.close()
#
# plt.figure()
# plt.plot(output2[3], color='cornflowerblue')
...
# plt.xlabel('iter')
# plt.ylabel('sigma')
# plt.savefig('images/all_rand5/sigma5000')
# plt.close()
#
# plt.figure()
# plt.plot(output2[4], color='cornflowerblue')
...
# plt.xlabel('iter')
# plt.ylabel('c')
# plt.savefig('images/all_rand5/c5000')
# plt.close()
#
# plt.figure()
# plt.plot(output2[5], color='cornflowerblue')
...
# plt.xlabel('iter')
# plt.ylabel('t')
# plt.savefig('images/all_rand5/t5000')
# plt.close()
#
# # CHAIN 1
#
...
# plt.ylabel('highest degree w')
# plt.legend()
# plt.savefig('images/all_rand5/w0_trace_chain5000')
# plt.close()
# # plot empirical 95% ci for highest and lowest degrees nodes
# plt.figure()
# w_est_fin = [w_est[i] for i in range(nburn, iter)]
...
# plt.ylabel('log w')
# plt.subplots_adjust(left=None, bottom=None, right=None, top=None, wspace=0.5, hspace=None)
# plt.savefig('images/all_rand5/w0_CI_chain5000')
# plt.close()
#
# # u_est = output2[8]
# # u_est_fin = [u_est[i] for i in range(nburn, iter)]
