...
# init[1]['c'] = 2
init[1]['x'] = x.copy()
init[1]['x'][index] = scipy.stats.norm.rvs(3, 0.1, len(index))
init[2] = {}
# init[2]['sigma'] = 0.2
# init[2]['t'] = 100
# init[2]['c'] = 1
init[2]['x'] = x.copy()
init[2]['x'][index] = scipy.stats.norm.rvs(3, 0.1, len(index))
...
out = chain.mcmc_chains([G, G, G], iter, nburn, index,
                        ...
                        save_every=save_every, plot=True,  path='deggreater2_L1000_threechains',
