    ...
    for i in range(iter):
        ...
        if w0 is True:
            if accept_params[-1] == 0:
                ...
                print('log post params', log_post_est[-1])
            ...
            if w_inference == 'HMC':
                ...
                print('log post w', log_post_est[-1])
        ...
        if n is True and (i + 1) % step_n == 0:
            ...
            log_post_est.append(temp[0])
            print('log post n', log_post_est[-1])
            ##
            nlogp = temp[1]
            nlogw = temp[2]
            ##
        ...
        if u is True:
            ...
            log_post_est.append(temp[0])
            print('log post u', log_post_est[-1])
            ##
            uw0 = temp[4]
            ##
            if (i + 1) % save_every == 0 and i != 0:
        ...
        if x is True and (i + 1) % step_x == 0:
            ...
            print('log post x', log_post_est[-1])
            ##
            nlogp = out_x[4]
            wpw = out_x[5]
            ##
